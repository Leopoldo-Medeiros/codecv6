                    ...
                    [
                        ...
                        'quiz' => [
                            [
                                ...
                                'options' => ['?? (null coalescing)', '?-> (nullsafe)', '-> (object access)', '?: (elvis)'],
                                'correct_index' => 1,
                            ...
                            [
                                ...
                                'options' => ['It can loop over cases', 'Strict (===) comparison and it returns a value', 'It runs faster at compile time', 'It allows fall-through between cases'],
                                'correct_index' => 1,
                            ...
                            [
                                ...
                                'options' => ['Enums use less memory', 'Illegal states and transitions become unrepresentable', 'Strings cannot be stored in a database', 'Enums are automatically cached'],
                                'correct_index' => 1,
                            ...
                            [
                                ...
                                'options' => ['It is stored by reference', 'Its properties cannot be mutated after construction', 'It is always a singleton', 'It bypasses the garbage collector'],
                                'correct_index' => 1,
