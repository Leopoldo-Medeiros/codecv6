                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            @endif
                            <p class="text-muted mb-1">{{ $user->profile ? $user->profile->profession : '' }}</p>
                            <p class="text-muted mb-4">{{ $user->profile ? $user->location : '' }}</p>
                        ...
                        <div class="card-body p-0">
                            <ul class="list-group list-group-flush rounded-3">
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                    ...
                                    <!-- Debug info: {{ isset($user->profile->github) ? 'GitHub exists: ' . $user->profile->github : 'GitHub does not exist' }} -->
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                    ...
                                    <!-- Debug info: {{ isset($user->profile->linkedin) ? 'LinkedIn exists: ' . $user->profile->linkedin : 'LinkedIn does not exist' }} -->
