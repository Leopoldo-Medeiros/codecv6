                        ...
                        <div class="table-responsive mb-50">
                            <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="ico-15 disabled-option"><span class="flaticon-cancel text-danger"></span></td>
                                    <td class="ico-20 color--theme"><span class="flaticon-check text-success me-2"></span></td>
                                    <td class="ico-20 color--theme"><span class="flaticon-check text-success me-2"></span></td>
                                </tr>
                    ...
                    <div class="col-lg-6">
                        <div class="questions-holder">
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Answer -->
                                <p class="color--grey">CODECV is a CV career consultancy company that helps IT professionals to create compelling CVs that will stand out from the crowd and land them more job interviews.
                                    Our team of expert consultants has a proven track record of success in helping IT professionals achieve their career goals, and we are committed to providing you with the best possible service.
                                </p>
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Answer -->
                                <p class="color--grey">All appointments could be done via WhatsApp, Instagram's DM or email.</p>
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Answer -->
                                <p class="color--grey">The first step is to book an appointment with CODE CV and explain to us your background.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="questions-holder">
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Question -->
                                <h5 class="s-22 w-700"><span>4.</span> What if I have any questions after the service?</h5>
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Answer -->
                                <p class="color--grey">The payment is done via PayPal or Revolut. The bank account details is sent by email.
                                </p>
                            ...
                            <div class="question mb-35 wow fadeInUp">
                                ...
                                <!-- Answer -->
                                <p class="color--grey">The consultancy is provide for Premium Service until the professional pass in the probation period
                                </p>
