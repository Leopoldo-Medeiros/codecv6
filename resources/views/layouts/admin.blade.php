...
<div class="container-fluid p-0 flex-shrink-0">
    <div class="row flex-nowrap">
        <div class="col-auto col-md-3 col-xl-2 pr-sm-2 px-0 pl-0 custom-menu-bg">
            <div id="sidebar" class="custom-menu-bg custom-sidebar-width d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white vh-100">
...
<!-- External Scripts -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script> <!-- Use only one version -->
