          ...
          <div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
            ...
            <div class="col">
              <ul class="bottom-footer-socials ico-20 text-end">
                <li><a href="https://www.instagram.com/codecv_info/" target="_blank"><span
                      class="flaticon-instagram"></span></a></li>
                <li><a href="https://www.linkedin.com/company/86762280" target="_blank"><img
                      src="/images/linkedin-icon.png" alt="LinkedIn Icon"></a></li>
              </ul>
            </div>
          </div> <!-- End row -->
