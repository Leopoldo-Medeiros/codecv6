  ...
  <div class="page">
    ...
    <div class="card">
      ...
      <div v-if="!token || !email" class="error-state">
        ...
        <NuxtLink to="/forgot-password" class="btn-primary" style="display:block;text-align:center;text-decoration:none;margin-top:1.25rem">
          Request New Link
        </NuxtLink>
      </div>
...
.eye-btn { position: absolute; right: 0.85rem; background: none; border: none; cursor: pointer; color: var(--dim); padding: 0; display: flex; align-items: center; transition: color .15s; }
...
.success p, .error-state p { font-size: 0.875rem; color: var(--muted); line-height: 1.6; }
</style>
