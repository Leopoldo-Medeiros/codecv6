  ...
  <div class="page">
    ...
    <div class="card">
      ...
      <div class="card__logo">
        <div class="logo-mark">
          <svg viewBox="0 0 32 32" fill="none">
            <rect width="32" height="32" rx="9" fill="url(#gr)"/>
            <path d="M9 16l4 4 10-10" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
            <defs>
              <linearGradient id="gr" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
      ...
      <div class="card__header">
        ...
        <p>Join CODECV and start your IT career in Ireland</p>
      </div>
      ...
      <form @submit.prevent="handleRegister" novalidate>
        ...
        <div class="field">
          ...
          <div class="field__wrap">
            ...
            <input id="fullname" v-model="form.fullname" type="text" placeholder="Lucas Medeiros"
        ...
        <div class="field">
          ...
          <div class="field__wrap">
            ...
            <input id="confirm" v-model="form.password_confirmation"
              ...
              class="has-eye" :disabled="loading"
              :class="{ mismatch: form.password_confirmation && form.password !== form.password_confirmation }"
              required />
          </div>
        </div>
...
.field__wrap input.mismatch { border-color: rgba(248,113,113,0.5); }
...
.strength__bar { flex: 1; height: 3px; border-radius: 9px; background: rgba(255,255,255,0.08); transition: background .3s; }
