    ...
    <div class="brand-panel">
      <div class="brand-panel__inner">
        ...
        <div class="brand-content">
          <h1>Welcome back<br/>to CODECV</h1>
          <p>Expert coaching, curated learning paths, and real job opportunities — everything you need to accelerate your IT career.</p>
        </div>
      ...
      <div class="form-panel__inner">
        ...
        <form @submit.prevent="handleLogin" novalidate>
          ...
          <div class="forgot-row">
            <NuxtLink to="/forgot-password" class="link">Forgot your password?</NuxtLink>
          </div>
        ...
        <p class="form-footer">Don't have an account? <NuxtLink to="/register" class="link">Sign up</NuxtLink></p>
...
.forgot-row { text-align: right; margin-top: -0.4rem; margin-bottom: 1.1rem; }
...
.btn-primary:hover:not(:disabled) { background: #0369a1; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(2,132,199,0.35); }
...
@media (max-width: 768px) {
  ...
  .brand-content { padding: 1.5rem 0; }
