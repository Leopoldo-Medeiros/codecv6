        ...
        <div class="card shadow-lg rounded-3">
          ...
          <div class="card-body p-4">
            <div class="text-center mb-4">
              ...
              <p class="text-muted">You are paying for the <b class="text-danger">{{ plan }}</b> plan.</p>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              <span class="text-danger">€<b>{{ price }}</b></span>
            </div>
            ...
            <div class="text-center">
              ...
              <img class="img-fluid qr-code" src="/images/QRCODE.jpg" alt="content-image">
            </div>
          </div>
...
const plan = computed(() => route.query.plan || 'Basic')
const price = computed(() => route.query.price || '99.00')
